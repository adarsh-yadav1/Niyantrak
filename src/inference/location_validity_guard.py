...
def load_restricted_zones(
    path=DEFAULT_RESTRICTED_ZONE_PATH
):
...
def check_road_corridor_proximity(
    ...
    """
    Blocks predictions for points too far from known road/corridor history.

    This catches lakes, empty land, parks, and random non-road locations
    even if they are inside Bengaluru.
    """
